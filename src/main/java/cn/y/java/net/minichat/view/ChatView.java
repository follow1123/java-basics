...
import cn.y.java.net.minichat.core.ui.RoundedBorder;
import cn.y.java.net.minichat.core.ui.TextView;
import cn.y.java.net.minichat.core.ui.View;
import cn.y.java.net.minichat.utils.StrUtil;
...
public class ChatView implements View {
    ...
    private void beforeRender(){
        ...
        viewList.add(new TextView(String.format("chat with %s", friendName)));
