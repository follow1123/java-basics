package cn.y.java.demo_projects.minichat.view;


import cn.y.java.demo_projects.minichat.core.ui.View;
import cn.y.java.demo_projects.minichat.core.ClientContext;
import cn.y.java.demo_projects.minichat.core.Message;
import cn.y.java.demo_projects.minichat.core.MsgType;
import cn.y.java.demo_projects.minichat.core.ui.RoundedBorder;
import cn.y.java.demo_projects.minichat.core.ui.TextView;
import cn.y.java.demo_projects.minichat.utils.StrUtil;
...
public class ChatView implements View {
    ...
    public ChatView(Scanner scanner, ClientContext context) {
        ...
        this.userFilesDir = System.getProperty("user.dir") + File.separator + "src/main/resources/minichat/userfiles";
